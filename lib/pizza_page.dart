...
class PizzaPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    CollectionReference pizzaRef = _firestore.collection('pizza-page');
    ...
    return Scaffold(
      ...
      body: FutureBuilder(
        future: pizzaRef.get(), // Asenkron veriyi burada alıyoruz
        builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            final pizzaListesi = snapshot.data!.docs;
            if (pizzaListesi.isEmpty) {
              return const Center(child: Text('Kayıt yok')); // Boş veri durumu
            }
            return ListView.builder(
              itemCount: pizzaListesi.length,
              itemBuilder: (context, index) {
                var pizza = pizzaListesi[index];
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${pizza['ingredient']}', // 'description' alanı
                        style: TextStyle(
                          fontFamily: 'Roboto',
